      ...
      <div class="row">
        ...
        <div class="col-10" style="left: 100px;">
          <div class="card-body">
            ...
            <div class="form-group row">
              <label for="no_hp" class="col-sm-2 col-form-label">Nomor <br>Handphone</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="no_hp" value="<?= $apa["no_hp"]; ?>">
              </div>
            </div>
            <hr />
            <div class="form-group row">
            ...
            <div class="form-group row">
              <label for="passwordConfirm" class="col-sm-2 col-form-label">Password <br>Confirm</label>
              <div class="col-sm-10">
            ...
            <div class="form-group row">
              ...
              <button type="reset" class="btn btn-danger btn-block" ><a href="index.php" style="color: white;">Cancel</a></button>
