        ...
        <div class="row content">
                ...
                <div class="p-5">
                    <form method="post" action="my_booking.php">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="inputNama" placeholder="" name="name" value="" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input required name="duration" placeholder="" class="form-control" type="number" min="1" aria-describedby="days">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="inputPhone" placeholder="" name="inputPhone" required>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 kanan px-2">
                <div class="container">
                    ...
                    <?php
                        if (empty($_GET['img'])) {
                            echo '<img class="img-fluid roomPreview prev" src="hotel2.jpg" alt="Pr">';
                        } 
                        ?>
                    </div>
